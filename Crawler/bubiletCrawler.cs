...
namespace Crawler
{
    public class BuBiletCrawler
    {
        ...
        //public async Task Konser()
        //{
        //    string apiUrl = "https://apiv2.bubilet.com.tr/api/Anasayfa/2/Etkinlikler"; // 1 tiyatro -- 
        ...
        //                using (ExcelPackage package = new ExcelPackage(excelFile))
        //                {
        //                    ExcelWorksheet existingWorksheet = package.Workbook.Worksheets.FirstOrDefault(sheet => sheet.Name == "BubiletKonser");
        //                    if (existingWorksheet != null)
        //                    {
        //                        package.Workbook.Worksheets.Delete(existingWorksheet);
        //                    }
        //                    ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("BubiletKonser");
        ...
        //public async Task Tiyatro()
        //{
        //    string apiUrl = "https://apiv2.bubilet.com.tr/api/Anasayfa/1/Etkinlikler"; // 1 tiyatro -- 
        ...
        //                using (ExcelPackage package = new ExcelPackage(excelFile))
        //                {
        //                    ExcelWorksheet existingWorksheet = package.Workbook.Worksheets.FirstOrDefault(sheet => sheet.Name == "BubiletTiyatro");
        //                    if (existingWorksheet != null)
        //                    {
        //                        package.Workbook.Worksheets.Delete(existingWorksheet);
        //                    }
        //                    ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("BubiletTiyatro");
        ...
        //static async Task GetEventDataCount()
        //{
        //    string apiUrl = "https://apiv2.bubilet.com.tr/api/Anasayfa/2/Etkinlikler";
        ...
        //                        if(mekan.SehirId == 34)
        //                        {
        //                            Console.WriteLine("bubilet.com");
        //                            Console.WriteLine($"{i + 1}. Etkinlik ID: {etkinlikData.etkinlikId} - Etkinlik Adı: {etkinlikData.etkinlikAdi}");
        //                            Console.WriteLine($"   Sanatçı: {sanatciNames}");
        //                            Console.WriteLine($"   Mekan Adı: {mekan.Baslik}");
        //                            Console.WriteLine($"   Tarih: {seans.tarih}");
        //                            Console.WriteLine($"   indirimliFiyat: {seans.indirimliFiyat}");
        //                            Console.WriteLine($"   Mekan Adresi: {mekan.Adres}");
        //                            Console.WriteLine($"   Link: {mekan.Adres}");

        //                            Console.WriteLine();
        //                        }

        //                    }
        //                    //await GetCityId(etkinlikData.etkinlikId.ToString());
        //                }
        //            }
        //            else
        //            {
